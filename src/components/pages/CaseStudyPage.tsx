      ...
      <section className="max-w-[1200px] mx-auto px-8 py-24">
        ...
        <Card className="glass p-8 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-border">
            <div>
              ...
              <p className="font-semibold">Digits (Multi-Company ERP)</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-semibold">Hatchit Solutions</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">TECH STACK</p>
              <p className="font-semibold text-sm">NestJS · TypeScript · PostgreSQL</p>
            </div>
          </div>
        </Card>
        ...
        <div className="space-y-16">
          <div>
            ...
            <div className="space-y-8">
              <Card className="glass p-8">
                <h3 className="text-destructive mb-4">The Incident</h3>
              ...
              <Card className="glass p-8">
                <h3 className="mb-4">The Investigation</h3>
                <p className="leading-relaxed">
              ...
              <Card className="glass p-8">
                <h3 className="mb-4">The Root Cause</h3>
          ...
          <div>
            ...
            <div className="space-y-8">
              <Card className="glass p-8">
                <h3 className="mb-4">Step 1: Reproduce the Bug</h3>
                <p className="leading-relaxed">
              ...
              <Card className="glass p-8">
                <h3 className="mb-6">Step 2: Atomic Operations</h3>
                ...
                <Tabs defaultValue="before" className="w-full">
                  <TabsList className="grid w-full max-w-md grid-cols-2 mb-4">
                    <TabsTrigger value="before">❌ Race Condition</TabsTrigger>
                    <TabsTrigger value="after">✓ Race-Free</TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="before">
                    <div className="relative">
                      <div className="absolute top-4 right-4 flex items-center gap-2">
                        ...
                        <span className="text-sm text-destructive font-semibold">Vulnerable</span>
                      </div>
                      <pre className="bg-card/50 p-6 rounded-lg border-l-4 border-destructive overflow-x-auto">
                        <code className="text-sm font-mono text-foreground/90">{`// Read (step 1)
...
if (stock >= quantity) {
                  ...
                  <TabsContent value="after">
                    <div className="relative">
                      <div className="absolute top-4 right-4 flex items-center gap-2">
                        ...
                        <span className="text-sm text-success font-semibold">Atomic</span>
                      </div>
                      <pre className="bg-card/50 p-6 rounded-lg border-l-4 border-success overflow-x-auto">
                        <code className="text-sm font-mono text-foreground/90">{`await prisma.$transaction(async (tx) => {
  // Validate first
  ...
  await tx.inventoryMovement.create({ data: {...} })
              ...
              <Card className="glass p-8">
                <h3 className="mb-4">Step 3: Transaction Guarantees</h3>
                <p className="leading-relaxed">
              ...
              <Card className="glass p-8">
                <h3 className="text-primary mb-4">The Key Insight</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <Card className="glass p-8">
                <h3 className="mb-4">Immediate Impact</h3>
              ...
              <Card className="glass p-8">
                <h3 className="mb-4">Long-term Impact</h3>
          ...
          <div>
            <h2 className="mb-6">Why This Matters for Your Team</h2>
          ...
          <div>
            <Card className="glass p-8">
              <h3 className="mb-4">Technical Deep Dive</h3>
      ...
      <section className="max-w-[1200px] mx-auto px-8 py-12">
        <Card className="glass p-12 text-center">
          <h2 className="mb-6">Let's Build Reliable Systems Together</h2>
