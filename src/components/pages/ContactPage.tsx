      ...
      <section className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-xl text-center text-muted-foreground mb-12 sm:mb-16 leading-relaxed">
            I'm currently seeking remote automation and integration engineering roles where I can apply
            my experience building systems that connect APIs, orchestrate workflows, and integrate AI services.
          </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto">
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground text-sm sm:text-base">
                  ...
                  <li>• AI/LLM service integration</li>
                  <li>• Multi-system data flows</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground text-sm sm:text-base">
                  <li>• Building connector systems</li>
                  <li>• Reliable automation at scale</li>
                  <li>• Integration-first architecture</li>
                  <li>• Continuous API evolution</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm sm:text-base">
                  Python, TypeScript, REST APIs, AI services, queuing systems
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm sm:text-base">
                  Seed to Series B (integration challenges, automation needs)
                </p>
              </div>
            </div>
          </Card>
